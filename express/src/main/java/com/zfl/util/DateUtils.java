...
public class DateUtils {
    ...
    public static final String SYS_ORDER = "yyyy-MMddHHmmss";
    /**
     * 日期相加减天数
    ...
    public static void main(String[] args) throws Exception {  
        ...
        System.out.println(DateUtils.dateFormat(DateUtils.dateAddHours(new Date(),-60), DateUtils.DATE_TIME_PATTERN));
        System.out.println(DateUtils.dateParse("2019-05-30 11:20:27", DateUtils.DATE_TIME_PATTERN));
        System.out.println(DateUtils.dateAddHours(new Date(),-25));
        System.out.println(DateUtils.dateParse("2019-05-29 14:08:27", DateUtils.DATE_TIME_PATTERN).before(DateUtils.dateAddHours(new Date(),-25)));
        /*
