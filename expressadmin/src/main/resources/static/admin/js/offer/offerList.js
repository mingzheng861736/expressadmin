layui.use(['layer','form','table','laydate'], function() {
    ...
    t = {
        ...
        cols: [[
            ...
            {field:'todayPrice',  title: '今日价格'},

            {field:'addTime',  title: '添加时间'},
            {fixed: 'right',title: '操作', align: 'center',toolbar: '#vipUserBar'}
        ]]
    };
    table.render(t);
    ...
    table.on('tool(vipUserList)', function(obj){
        ...
        if(obj.event === 'edit'){
            var editIndex = layer.open({
                title : "查看详细信息",
                type : 2,
                content : "/admin/offer/inlet?id="+data.id,
        ...
        if(obj.event === "del"){
            layer.confirm("你确定要删除么？",{btn:['是的,我确定','我再想想']},
                function(){
                    $.post("/admin/offer/delete",{"id":data.id},function (res){
                        if(res.success){
